...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "HOTBOX 4-8B80";  // You will connect your phone to this Access Point
const char *pw = "QZT7LW79HPRS"; // and this is the password
...
const char *pw = "MyPassword"; // and WiFi PASSWORD
const int port = 9876;
